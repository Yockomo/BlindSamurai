...
public class PlatformerMovement : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (playerStates.IsJumpCut)
		{
			...
			rigidBody.velocity = new Vector2(rigidBody.velocity.x, Mathf.Max(rigidBody.velocity.y, -moveData.maxFallSpeed));
		}
		else if ((playerStates.IsJumping || playerStates.IsWallJumping || playerStates.IsJumpFalling) && Mathf.Abs(rigidBody.velocity.y) < moveData.jumpHangTimeThreshold)
		{
